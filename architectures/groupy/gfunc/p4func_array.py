...
import numpy as np
import architectures.groupy.garray.p4_array as p4a
...
def tst():
    ...
    from architectures.groupy.garray.p4_array import P4Array, meshgrid, u_range, v_range, rotation, translation

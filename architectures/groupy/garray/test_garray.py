...
def test_p4_array():
    from architectures.groupy.garray import p4_array
    check_wallpaper_group(p4_array, p4_array.P4Array)


def test_p4m_array():
    from architectures.groupy.garray import p4m_array
    check_wallpaper_group(p4m_array, p4m_array.P4MArray)


def test_z2_array():
    from architectures.groupy.garray import Z2_array
    check_wallpaper_group(Z2_array, Z2_array.Z2Array)


def test_c4_array():
    from architectures.groupy.garray import C4_array
    check_finite_group(C4_array, C4_array.C4Array, C4_array.C4)


def test_d4_array():
    from architectures.groupy.garray import D4_array
